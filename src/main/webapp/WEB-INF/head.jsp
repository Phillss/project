...
<script  src="${pageContext.request.contextPath}/static/lib/naranja.min.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/lib/naranja.min.css">
